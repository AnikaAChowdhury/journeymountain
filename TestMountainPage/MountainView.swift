...
let mountain_4 = Mountain(monthNumber: 4, worldColor: Color(UIColor(red: 0.604, green: 0.898, blue: 0.961, alpha: 1).cgColor), clouds: "cloud", hasClouds: true,  decoration1: "spring_tree", decoration2: "spring_tree", decoration3: "flower_bush", decoration4: "orange_flower", showDecoration1: true, showDecoration2: false, showDecoration3: true, showDecoration4: true, hasSnow: false, sizeDecoration1: 0.17, sizeDecoration2: 0.17, sizeDecoration3: 0.12, sizeDecoration4: 0.08)
