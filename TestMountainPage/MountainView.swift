...
let mountain_4 = Mountain(monthNumber: 4, worldColor: Color(UIColor(red: 0.996, green: 0.661, blue: 0.473, alpha: 1).cgColor), clouds: "cloud", hasClouds: true,  decoration1: "flower_bush", decoration2: "", decoration3: "orange_flower", decoration4: "orange_flower", showDecoration1: true, showDecoration2: false, showDecoration3: true, showDecoration4: true, hasSnow: false, sizeDecoration1: 0.1, sizeDecoration2: 0.1, sizeDecoration3: 0.1, sizeDecoration4: 0.1)
...
let mountain_10 = Mountain(monthNumber: 10, worldColor: Color(UIColor(red: 0.612, green: 0.153, blue: 0.686, alpha: 1).cgColor), clouds: "cloud_grey", hasClouds: true,  decoration1: "tree_halloween", decoration2: "tree_halloween", decoration3: "ghost", decoration4: "pumpkin_halloween", showDecoration1: true, showDecoration2: true, showDecoration3: true, showDecoration4: true, hasSnow: false, sizeDecoration1: 0.1, sizeDecoration2: 0.1, sizeDecoration3: 0.1, sizeDecoration4: 0.1)
...
let mountain_12 = Mountain(monthNumber: 12, worldColor: Color(UIColor(red: 0.871, green: 0.977, blue: 1, alpha: 1).cgColor), clouds: "cloud", hasClouds: true,  decoration1: "christmas_tree", decoration2: "presents_1", decoration3: "presents_2", decoration4: "reindeer", showDecoration1: true, showDecoration2: true, showDecoration3: true, showDecoration4: true, hasSnow: true, sizeDecoration1: 0.1, sizeDecoration2: 0.1, sizeDecoration3: 0.1, sizeDecoration4: 0.1)
